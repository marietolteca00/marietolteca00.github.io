...
Using the website \[Marvel Rivals Tracker\]\['https://rivalsmeta.com/'\], I set up an API to download my personal gameplay statistics from Seasons 3–6. Below, I show how I retrieved my data using my gamer tag.
...
knitr::include_graphics(here::here("blog_post","MarvelRivals_post","K_D_Comparison_Heroes.png"))
```
